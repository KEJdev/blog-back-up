...
![weight1](/public/img/weight1.png){: width="70%" height="70%" }{: .center}

아래의 그림은 학습이 잘된 경우입니다. 

![weight2](/public/img/weight2.png){: width="70%" height="70%" }{: .center}
...
![weight3](/public/img/weight3.png){: width="70%" height="70%" }{: .center}
...
![weight4](/public/img/weight4.png){: width="70%" height="70%" }{: .center}

**4.Xavier 초기값 선정.**

표준편차가 √(1/n)인 (n은 앞층의 노드 수) 정규분포로 초기화하는 방법이 있으며 sigmoid 함수와 짝궁이며 같이 사용됩니다. 

![weight5](/public/img/weight5.png){: width="70%" height="70%" }{: .center}
...
![batch1](/public/img/batch1.png){: width="70%" height="70%" }{: .center}
