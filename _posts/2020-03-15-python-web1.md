...
여기서 알아야 할 점은 주소가 위 그림처럼 뜨지만, 주소를 복붙하면 아래처럼 암호화 된 주소가 보여집니다. 그렇기 때문에 직접 URL를 건들어서 웹 스크롤링을 하기는 힘들다는 점을 알아두셔야합니다. 

암호화 된 주소 ↓  

http://search.hani.co.kr/Search?command=query&keyword=%EC%9D%B8%EA%B3%B5%EC%A7%80%EB%8A%A5&sort=d&period=all&media=news
