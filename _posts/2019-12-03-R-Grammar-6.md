...
<img src="../assets/images/r6.png" width="120" height="50">
...
<img src="../assets/images/r7.png" width="390" height="70">
...
<img src="../assets/images/r8.png" width="180" height="50">

원본 데이터를 확인해보도록 하겠습니다. 

<img src="../assets/images/r9.png" width="340" height="20">

마지막 2와 출력 결과인 2가 일치하는 결과를 확인할 수 있습니다.   
다음 포스팅에는 유방암 데이터를 이용하여 악성인지 양성인지 분류해보고 조금 더 깊게 들어가기 위해 이원교차표와 적절한 k값을 찾는 방법에 대해 알아보겠습니다. 전체 코드는 [여기]()에서 보실 수 있습니다.